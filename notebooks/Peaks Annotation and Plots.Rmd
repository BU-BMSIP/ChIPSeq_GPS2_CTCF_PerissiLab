...
peaks <- readPeakFile("/projectnb/perissilab/Xinyu/GPS2_CHIPseq/CTCF_3T3L1/results/intersect/CTCF_GPS2_overlap_union_t1to4_3T3L1_mm39.bed")
...
output_file <- file.path(output_dir, paste0(basename("CTCF_GPS2_overlap_union_t1to4_3T3L1_mm39"), "_annotated.txt"))
