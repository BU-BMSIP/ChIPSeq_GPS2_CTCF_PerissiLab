...
peaks <- readPeakFile("/projectnb/perissilab/Xinyu/GPS2_CHIPseq/all_peaks_merged.bed")
...
output_dir <- "/projectnb/perissilab/Xinyu/GPS2_CHIPseq"

# Create the directory if it does not exist
if (!dir.exists(output_dir)) {
  dir.create(output_dir, recursive = TRUE)}

output_file <- file.path(output_dir, paste0(basename("GPS2_CTCFpeaks_merged"), "_annotated.txt"))
...
filepath <- file.path(output_dir, "CTCF_t1.png")
png(filename = filepath, width = 8, height = 6, units = "in", rnes = 300)
