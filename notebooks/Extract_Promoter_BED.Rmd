...
#  files: [""]  # List of files to process
  input_dir: "/projectnb/perissilab/Xinyu/GPS2_CHIPseq/Silencing/GPS2/results/annotation"                     # Folder containing annotated txt files
  output_dir: "/projectnb/perissilab/Xinyu/GPS2_CHIPseq/Silencing/GPS2/results/annotation"                        # Folder to save .bed files
  files: ["sictl_filtered_by_GPS2_CTCF_common.txt"]  # List of files to process
